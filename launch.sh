...
echo ""
echo "⚠️  Accetta i certificati delle seguenti pagine (se non già fatto):"
echo "   -Backend API: https://$HOST_ID:9443"
echo "   -Backend per Google: https://transcendence.be:9443"
echo ""
echo "🌐 Accedi tramite:"
echo "   -Frontend: https://transcendence.fe:8443"
echo "   -Backend Swagger (per test): https://transcendence.be:9443/swagger"
echo ""
